...
// Define CommentRatio interface directly in this file instead of importing it
interface CommentRatio {
  file?: string; // Add file property to fix the error
  codeLines: number;
  commentLines: number;
  ratio: number;
  commentedOutCode?: boolean; // Add property used in the code
}
