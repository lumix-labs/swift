...
export function RepositoriesDropdown({ resolvedTheme }: RepositoriesDropdownProps) {
  ...
  const onAddClick = useCallback((e: React.MouseEvent) => {
    if (handleAddClick(e)) {
      setShow(false);
    }
  ...
  const onRepositorySelect = useCallback((id: string) => {
      ...
      return (
        <div className="p-4 text-center">
          <div className="flex justify-center items-center space-x-2">
            <div className="w-4 h-4 border-2 border-gray-500 dark:border-gray-400 
      ...
      >
        <div className="flex flex-col space-y-2">
          <div className="flex justify-between items-center">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-gray-500 dark:text-gray-400" 
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {show && (
        <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-gray-900 
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" 
                  ...
                  <path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 
                                             ...
                                             5.707a1 1 0 010-1.414z" clipRule="evenodd" />
                </svg>
              ...
              {isUpdating ? (
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" 
                  ...
                  <path fillRule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 
                                             11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" clipRule="evenodd" />
                </svg>
              )}
              Add new repository
            </button>
